...
namespace MetricsDiscoveryInternal
{
    ...
    public:
        ...
        bool ParseEquationString( const char* equationString, const uint32_t reportSize );
        bool ParseEquationElement( const char* equationString, const uint32_t reportSize );
