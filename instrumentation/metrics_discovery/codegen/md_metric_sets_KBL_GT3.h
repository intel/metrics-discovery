...
//     File Name:  md_metric_sets_KBL_GT3.h
//
...
namespace MetricsDiscoveryInternal::MetricSets_KBL_GT3_MMIO_Regs
{
...
namespace MetricsDiscoveryInternal::MetricSets_KBL_GT3_PipelineStatistics
{
...
namespace MetricsDiscoveryInternal::MetricSets_KBL_GT3_OA
{
    void AddInformationSet( CConcurrentGroup* concurrentGroup );
