...
static TCompletionCode CreateMetricSet_ADLS_PipelineStats( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
...
{    
    ...
    SetPlatformMask( &platformMask, GENERATION_ADLS, adapterId );
...
static TCompletionCode CreateMetricSet_ADLS_RenderBasic( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x5f110a00, REGISTER_TYPE_NOA ));
...
static TCompletionCode CreateMetricSet_ADLS_ComputeBasic( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_AsyncCompute( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_XveActivity1( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_GpuBusyness( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x0f0d8000, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x012d8000, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x47100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x49101004, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4b100406, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4d100a00, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x31100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9884, 0x00000003, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x65100002, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9884, 0x00000000, REGISTER_TYPE_NOA ));
...
static TCompletionCode CreateMetricSet_ADLS_HDCAndSF( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x00110077, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x0e310077, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4d100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4f100310, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x17100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x31100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9884, 0x00000003, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x65100002, REGISTER_TYPE_NOA ));
...
static TCompletionCode CreateMetricSet_ADLS_L3_1( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_L3_2( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_L3_3( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_L3_4( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_L3_5( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_L3_6( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
...
static TCompletionCode CreateMetricSet_ADLS_RasterizerAndPixelBackend( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4b114000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x5f11aa80, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x6111000a, REGISTER_TYPE_NOA ));
...
static TCompletionCode CreateMetricSet_ADLS_RenderPipeProfile( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x140bbc00, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4d100200, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4f100004, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x51100208, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x47100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x49100404, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4b100004, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9884, 0x00000003, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x65100002, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9884, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x42000001, REGISTER_TYPE_NOA ));
...
static TCompletionCode CreateMetricSet_ADLS_Sampler( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4b114000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x5f11a000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x611102aa, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x47100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4d100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x4f100604, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x5110060a, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x5310000a, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x55100004, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x17100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x31100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9884, 0x00000003, REGISTER_TYPE_NOA ));
...
static TCompletionCode CreateMetricSet_ADLS_TDL( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x040b4000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x040dc000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x0e0dc000, REGISTER_TYPE_NOA ));
...
static TCompletionCode CreateMetricSet_ADLS_TestOa( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, TByteArrayLatest* platformMask )
{
    const uint32_t adapterId            = OBTAIN_ADAPTER_ID( metricsDevice );
    CMetricSet*    metricSet            = nullptr;
    CMetric*       metric               = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x17100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x55100a00, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x57100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x31100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9884, 0x00000003, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET_A( adapterId, metricSet->AddStartConfigRegister( 0x9888, 0x65100002, REGISTER_TYPE_NOA ));
