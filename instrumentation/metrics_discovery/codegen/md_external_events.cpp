...
const char ExternalEvents::archEvents[33411] = "Group Mask,Event Encoding,Architectural Event Name,Event Definition,OA Reporting,Disaggregation Mode,Project,Group Name,Instance,Filter,Metric Result Units,Metric Type,Hw Unit Type,Normalization\n"
                                               ...
                                               "1,1024,SHADER_PIX_KILL,Number of pixels that were lit from Rasterizer but killed by the Pixel Shader or OOB Check,RG,1,BMG LNL PTL,Color Pipe,xecore,,events,1,2,2\n"
                                               ...
                                               "1,1026,POSTPS_ALPHA_TEST_FAIL,Number of 2x2 that were lit from Rasterizer but failed the Alpha Test or Alpha-to-Coverage,RG,1,BMG LNL PTL,Color Pipe,xecore,,events,1,2,2\n"
                                               ...
                                               "1,6149,THREADGROUP_DISPATCH_QUEUE0_INPUT_AVAILABLE,Number of cycles Thread Spawner has input available on queue 0,RG,1,BMG LNL PTL,Thread Dispatcher,xecore,,cycles,1,2,3\n"
                                               "1,6150,THREADGROUP_DISPATCH_QUEUE1_INPUT_AVAILABLE,Number of cycles Thread Spawner has input available on queue 1,CG,1,BMG LNL PTL,Thread Dispatcher,xecore,,cycles,1,2,3\n"
                                               ...
                                               "2,16384,PIXEL_WRITE,Number of pixels written to all render targets,RG,,BMG LNL PTL,Color Pipe,l3node,,events,1,0,2\n"
                                               "2,16385,PIXEL_BLEND,Number of blended pixels written to all render targets,RG,,BMG LNL PTL,Color Pipe,l3node,,events,1,0,2\n"
                                               "2,16386,COLOR_PIPE_CACHE_LATENCY2_STALL,Number of cycles Color Pipeline stalled due to Render Cache latency hiding structure full,RG,,BMG LNL PTL,Color Pipe,l3node,,cycles,1,0,3\n"
                                               ...
                                               "2,24070,GPU_MEMORY_64B_TRANSACTION_READ,\"Number of device local memory (HBM, GDDR, LPDDR, etc.) non coherent reads (64B)\",G,,BMG LNL PTL,Memory,sqidi,,events,1,0,2\n"
                                               "2,24071,GPU_MEMORY_64B_TRANSACTION_WRITE,\"Number of device local memory (HBM, GDDR, LPDDR, etc.) non coherent writes (64B)\",G,,BMG LNL PTL,Memory,sqidi,,events,1,0,2\n"
                                               "2,24072,GPU_MEMORY_32B_TRANSACTION_READ,\"Number of device local memory (HBM, GDDR, LPDDR, etc.) non coherent reads (32B)\",G,,BMG LNL PTL,Memory,sqidi,,events,1,0,2\n"
                                               "2,24073,GPU_MEMORY_32B_TRANSACTION_WRITE,\"Number of device local memory (HBM, GDDR, LPDDR, etc.) non coherent writes (32B)\",G,,BMG LNL PTL,Memory,sqidi,,events,1,0,2\n"
...
const char ExternalEvents::hwEvents[46779] = "Architectural Event Name,Hw Event Name,Hw Event Short Name,Hw Event Description,Filter Value,Project\n"
                                             ...
                                             "SHADER_PIX_KILL,SHADER_PIX_KILL,Shader Pix Kill,Number of pixels that were lit from Rasterizer but killed by the Pixel Shader or OOB Check,0,BMG LNL PTL\n"
                                             ...
                                             "POSTPS_ALPHA_TEST_FAIL,POSTPS_ALPHA_TEST_FAIL,PostPS Alpha Test Fail,Number of 2x2 that were lit from Rasterizer but failed the Alpha Test or Alpha-to-Coverage,0,BMG LNL PTL\n"
                                             ...
                                             "THREADGROUP_DISPATCH_QUEUE0_INPUT_AVAILABLE,THREADGROUP_DISPATCH_QUEUE0_INPUT_AVAILABLE_CYCLES,Threadgroup Dispatch Queue0 Input Available Cycles,Number of cycles Thread Spawner has input available on queue 0,0,BMG LNL PTL\n"
                                             "THREADGROUP_DISPATCH_QUEUE1_INPUT_AVAILABLE,THREADGROUP_DISPATCH_QUEUE1_INPUT_AVAILABLE_CYCLES,Threadgroup Dispatch Queue1 Input Available Cycles,Number of cycles Thread Spawner has input available on queue 1,0,BMG LNL PTL\n"
                                             ...
                                             "GPU_MEMORY_64B_TRANSACTION_READ,GPU_MEMORY_64B_TRANSACTION_READ,GPU Memory 64b Transaction Read,\"Number of device local memory (HBM, GDDR, LPDDR, etc.) non coherent reads (64B)\",0,BMG LNL PTL\n"
                                             "GPU_MEMORY_64B_TRANSACTION_WRITE,GPU_MEMORY_64B_TRANSACTION_WRITE,GPU Memory 64b Transaction Write,\"Number of device local memory (HBM, GDDR, LPDDR, etc.) non coherent writes (64B)\",0,BMG LNL PTL\n"
                                             "GPU_MEMORY_32B_TRANSACTION_READ,GPU_MEMORY_32B_TRANSACTION_READ,GPU Memory 32b Transaction Read,\"Number of device local memory (HBM, GDDR, LPDDR, etc.) non coherent reads (32B)\",0,BMG LNL PTL\n"
                                             "GPU_MEMORY_32B_TRANSACTION_WRITE,GPU_MEMORY_32B_TRANSACTION_WRITE,GPU Memory 32b Transaction Write,\"Number of device local memory (HBM, GDDR, LPDDR, etc.) non coherent writes (32B)\",0,BMG LNL PTL\n"
...
const char ExternalEventsMedia::archEvents[2001] = "Group Mask,Event Encoding,Architectural Event Name,Event Definition,OA Reporting,OAM Unit,Project,Group Name,Metric Result Units,Metric Type,Hw Unit Type,Normalization\n"
                                                   "1,1,MEDIA_READ_REQUEST,Number of read requests from stand alone media,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,2,MEDIA_WRITE_REQUEST,Number of write requests from stand alone media,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,3,COMMAND_PARSER_GRAPHICS_SECURITY_CONTROLLER_BUSY,Number of GSCCS activities,M,SAG,MTL BMG LNL PTL ARL,Media,cycles,1,0,1\n"
                                                   "1,512,COMMAND_PARSER_VIDEO_DECODE_ENGINE0_BUSY,Number of VCS0 (VDBOX0) activities,M,SCMI,MTL BMG LNL PTL ARL,Media,cycles,1,0,1\n"
                                                   "1,513,VIDEO_DECODE_BOX0_READ_REQUEST,Number of VDBOX0 read requests,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,514,VIDEO_DECODE_BOX0_WRITE_REQUEST,Number of VDBOX0 write requests,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,1024,COMMAND_PARSER_VIDEO_DECODE_ENGINE1_BUSY,Number of VCS1 (VDBOX1) activities,M,SCMI,MTL BMG LNL PTL ARL,Media,cycles,1,0,1\n"
                                                   "1,1025,VIDEO_DECODE_BOX1_READ_REQUEST,Number of VDBOX1 read requests,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,1026,VIDEO_DECODE_BOX1_WRITE_REQUEST,Number of VDBOX1 write requests,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,8704,COMMAND_PARSER_VIDEO_ENHANCEMENT_ENGINE0_BUSY,Number of VECS0 (VEBOX0) activities,M,SCMI,MTL BMG LNL PTL ARL,Media,cycles,1,0,1\n"
                                                   "1,8705,VIDEO_ENHANCEMENT_BOX0_READ_REQUEST,Number of VEBOX0 read requests,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,8706,VIDEO_ENHANCEMENT_BOX0_WRITE_REQUEST,Number of VEBOX0 write requests,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,9216,COMMAND_PARSER_VIDEO_ENHANCEMENT_ENGINE1_BUSY,Number of VECS1 (VEBOX1) activities,M,SCMI,MTL BMG LNL PTL ARL,Media,cycles,1,0,1\n"
                                                   "1,9217,VIDEO_ENHANCEMENT_BOX1_READ_REQUEST,Number of VEBOX1 read requests,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "1,9218,VIDEO_ENHANCEMENT_BOX1_WRITE_REQUEST,Number of VEBOX1 write requests,M,SCMI,MTL BMG LNL PTL ARL,Media,events,1,0,0\n"
                                                   "";

const char ExternalEventsMedia::hwEvents[2577] = "Architectural Event Name,Hw Event Name,Hw Event Short Name,Hw Event Description,Project\n"
                                                 "MEDIA_READ_REQUEST,MEDIA_READ_REQUEST,Media Read Request,Number of read requests from stand alone media,MTL BMG LNL PTL ARL\n"
                                                 "MEDIA_WRITE_REQUEST,MEDIA_WRITE_REQUEST,Media Write Request,Number of write requests from stand alone media,MTL BMG LNL PTL ARL\n"
                                                 "COMMAND_PARSER_GRAPHICS_SECURITY_CONTROLLER_BUSY,COMMAND_PARSER_GRAPHICS_SECURITY_CONTROLLER_BUSY_CYCLES,Command Parser Graphics Security Controller Busy Cycles,Number of GSCCS activities,MTL BMG LNL PTL ARL\n"
                                                 "COMMAND_PARSER_VIDEO_DECODE_ENGINE0_BUSY,COMMAND_PARSER_VIDEO_DECODE_ENGINE0_BUSY_CYCLES,Command Parser Video Decode Engine0 Busy Cycles,Number of VCS0 (VDBOX0) activities,MTL BMG LNL PTL ARL\n"
                                                 "VIDEO_DECODE_BOX0_READ_REQUEST,VIDEO_DECODE_BOX0_READ_REQUEST,Video Decode Box0 Read Request,Number of VDBOX0 read requests,MTL BMG LNL PTL ARL\n"
                                                 "VIDEO_DECODE_BOX0_WRITE_REQUEST,VIDEO_DECODE_BOX0_WRITE_REQUEST,Video Decode Box0 Write Request,Number of VDBOX0 write requests,MTL BMG LNL PTL ARL\n"
                                                 "COMMAND_PARSER_VIDEO_DECODE_ENGINE1_BUSY,COMMAND_PARSER_VIDEO_DECODE_ENGINE1_BUSY_CYCLES,Command Parser Video Decode Engine1 Busy Cycles,Number of VCS1 (VDBOX1) activities,MTL BMG LNL PTL ARL\n"
                                                 "VIDEO_DECODE_BOX1_READ_REQUEST,VIDEO_DECODE_BOX1_READ_REQUEST,Video Decode Box1 Read Request,Number of VDBOX1 read requests,MTL BMG LNL PTL ARL\n"
                                                 "VIDEO_DECODE_BOX1_WRITE_REQUEST,VIDEO_DECODE_BOX1_WRITE_REQUEST,Video Decode Box1 Write Request,Number of VDBOX1 write requests,MTL BMG LNL PTL ARL\n"
                                                 "COMMAND_PARSER_VIDEO_ENHANCEMENT_ENGINE0_BUSY,COMMAND_PARSER_VIDEO_ENHANCEMENT_ENGINE0_BUSY_CYCLES,Command Parser Video Enhancement Engine0 Busy Cycles,Number of VECS0 (VEBOX0) activities,MTL BMG LNL PTL ARL\n"
                                                 "VIDEO_ENHANCEMENT_BOX0_READ_REQUEST,VIDEO_ENHANCEMENT_BOX0_READ_REQUEST,Video Enhancement Box0 Read Request,Number of VEBOX0 read requests,MTL BMG LNL PTL ARL\n"
                                                 "VIDEO_ENHANCEMENT_BOX0_WRITE_REQUEST,VIDEO_ENHANCEMENT_BOX0_WRITE_REQUEST,Video Enhancement Box0 Write Request,Number of VEBOX0 write requests,MTL BMG LNL PTL ARL\n"
                                                 "COMMAND_PARSER_VIDEO_ENHANCEMENT_ENGINE1_BUSY,COMMAND_PARSER_VIDEO_ENHANCEMENT_ENGINE1_BUSY_CYCLES,Command Parser Video Enhancement Engine1 Busy Cycles,Number of VECS1 (VEBOX1) activities,MTL BMG LNL PTL ARL\n"
                                                 "VIDEO_ENHANCEMENT_BOX1_READ_REQUEST,VIDEO_ENHANCEMENT_BOX1_READ_REQUEST,Video Enhancement Box1 Read Request,Number of VEBOX1 read requests,MTL BMG LNL PTL ARL\n"
                                                 "VIDEO_ENHANCEMENT_BOX1_WRITE_REQUEST,VIDEO_ENHANCEMENT_BOX1_WRITE_REQUEST,Video Enhancement Box1 Write Request,Number of VEBOX1 write requests,MTL BMG LNL PTL ARL\n"
                                                 "";
