...
namespace MetricsDiscoveryInternal::MetricSets_DG1_OA
{
    ...
    TCompletionCode CTestOaMetricSet::Initialize()
    {
        ...
        metric = AddMetric( "Counter9", "TestCounter9 - OAR enable",
            ...
            "GPU", ( METRIC_GROUP_NAME_ID_GPU * 0x1000000 ), USAGE_FLAG_FRAME | USAGE_FLAG_BATCH | USAGE_FLAG_DRAW, API_TYPE_DX9 | API_TYPE_DX10 | API_TYPE_DX11 | API_TYPE_OGL | API_TYPE_OGL4_X | API_TYPE_OCL | API_TYPE_DX12 | API_TYPE_VULKAN,
