...
namespace MetricsDiscoveryInternal::MetricSets_BDW_OA
{
    ...
    class CDataPortReadsCoalescingMetricSet final : public CMetricSet
    {
    public:
    ...
    class CDataPortWritesCoalescingMetricSet final : public CMetricSet
    {
    public:
    ...
    class CSTC_PmaStallMetricSet final : public CMetricSet
    {
    public:
