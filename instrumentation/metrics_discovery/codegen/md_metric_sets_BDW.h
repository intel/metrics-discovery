...
//     File Name:  md_metric_sets_BDW.h
//
...
namespace MetricsDiscoveryInternal::MetricSets_BDW_MMIO_Regs
{
...
namespace MetricsDiscoveryInternal::MetricSets_BDW_PipelineStatistics
{
...
namespace MetricsDiscoveryInternal::MetricSets_BDW_OA
{
    ...
    class CDataPortReadsCoalescingMetricSet : public CMetricSet
    {
    public:
        CDataPortReadsCoalescingMetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );

        TCompletionCode Initialize();
    };

    class CDataPortWritesCoalescingMetricSet : public CMetricSet
    {
    public:
        CDataPortWritesCoalescingMetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );
    ...
    class CSTC_PmaStallMetricSet : public CMetricSet
    {
    public:
        CSTC_PmaStallMetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );
