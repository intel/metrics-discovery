...
static TCompletionCode CreateMetricSet_HSW_PipelineStats( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, uint32_t platformMask )
{
...
static TCompletionCode CreateMetricSet_HSW_RenderBasic( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, uint32_t platformMask )
{
    CMetricSet*   metricSet            = nullptr;
    CMetric*      metric               = nullptr;
    CInformation* information          = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1c0" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x20" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x30" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x34" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x48" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x70" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x84" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x5c" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xb0" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x10" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x10" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "EuAggrDuration" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x14" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x18" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "EuAggrDuration" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x14" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x18" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $VsThreads UDIV" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x18" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x20" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $VsThreads UDIV" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x28" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x40" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "EuAggrDuration" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x28" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x40" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $HsThreads UDIV" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x2c" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x48" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $HsThreads UDIV" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x3c" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x3c" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x68" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $DsThreads UDIV" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x40" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x64" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x64" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0xb8" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $GsThreads UDIV" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x68" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x50" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x50" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x90" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $CsThreads UDIV" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x54" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x78" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x78" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0xe0" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $PsThreads UDIV" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0x7c" ));
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Sampler0Busy $Sampler1Busy UADD $GpuCoreClocks FDIV 2 FDIV 100 FMUL" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$$Sampler0Texels $$Sampler1Texels UADD $EuSlicesTotalCount UMUL" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xd8 dw@0xdc UADD 2 UMUL" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1a0 qw@0x1a8 UADD 2 UMUL" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $EuSlicesTotalCount UMUL 64 UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xa0" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xa4" ));
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xa8" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x140" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $SamplesKilledInPs USUB" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xac" ));
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1d8" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $EuSlicesTotalCount 4 UMUL UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1e0" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self 128 UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "$GpuCoreClocks 64 UMUL" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1e8" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self 64 UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "$GpuCoreClocks 32 UMUL" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1f0" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1f0 qw@0x1e8 USUB" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self 64 UMUL" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "$GpuCoreClocks 64 UMUL" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$$LlcHits $$LlcAccesses FDIV $$LlcGpuThroughput FMUL 1 UMUL" ));
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$PsEuActive $EuActive UMUL $VsEuActive $HsEuActive UADD $DsEuActive UADD $CsEuActive UADD $GsEuActive UADD $PsEuActive UADD UDIV $PsEuStall $EuStall UMUL $VsEuStall $HsEuStall UADD $DsEuStall UADD $CsEuStall UADD $GsEuStall UADD $PsEuStall UADD UDIV UADD $GpuTime UMUL $GpuCoreClocks $EuCoresTotalCount UMUL 1000 UMUL UDIV" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$VsEuActive $EuActive UMUL $VsEuActive $HsEuActive UADD $DsEuActive UADD $CsEuActive UADD $GsEuActive UADD $PsEuActive UADD UDIV $VsEuStall $EuStall UMUL $VsEuStall $HsEuStall UADD $DsEuStall UADD $CsEuStall UADD $GsEuStall UADD $PsEuStall UADD UDIV UADD $GpuTime UMUL $GpuCoreClocks $EuCoresTotalCount UMUL 1000 UMUL UDIV" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$GsEuActive $EuActive UMUL $VsEuActive $HsEuActive UADD $DsEuActive UADD $CsEuActive UADD $GsEuActive UADD $PsEuActive UADD UDIV $GsEuStall $EuStall UMUL $VsEuStall $HsEuStall UADD $DsEuStall UADD $CsEuStall UADD $GsEuStall UADD $PsEuStall UADD UDIV UADD $GpuTime UMUL $GpuCoreClocks $EuCoresTotalCount UMUL 1000 UMUL UDIV" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$HsEuActive $EuActive UMUL $VsEuActive $HsEuActive UADD $DsEuActive UADD $CsEuActive UADD $GsEuActive UADD $PsEuActive UADD UDIV $HsEuStall $EuStall UMUL $VsEuStall $HsEuStall UADD $DsEuStall UADD $CsEuStall UADD $GsEuStall UADD $PsEuStall UADD UDIV UADD $GpuTime UMUL $GpuCoreClocks $EuCoresTotalCount UMUL 1000 UMUL UDIV" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$CsEuActive $EuActive UMUL $VsEuActive $HsEuActive UADD $DsEuActive UADD $CsEuActive UADD $GsEuActive UADD $PsEuActive UADD UDIV $CsEuStall $EuStall UMUL $VsEuStall $HsEuStall UADD $DsEuStall UADD $CsEuStall UADD $GsEuStall UADD $PsEuStall UADD UDIV UADD $GpuTime UMUL $GpuCoreClocks $EuCoresTotalCount UMUL 1000 UMUL UDIV" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "100 $$EuActive $$EuStall FADD FSUB" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
        ...
        if( information )
        {
            ...
            MD_CHECK_CC_RET( information->SetDeltaReportReadEquation( "qw@0x168" ));
        ...
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x253A4, 0x01600000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25440, 0x00100000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25128, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2691C, 0x00000800, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26AA0, 0x01500000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26B9C, 0x00006000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2791C, 0x00000800, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27AA0, 0x01500000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27B9C, 0x00006000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2641C, 0x00000400, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25380, 0x00000010, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2538C, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25384, 0x0800AAAA, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25400, 0x00000004, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2540C, 0x06029000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25410, 0x00000002, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25404, 0x5C30FFFF, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25100, 0x00000016, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25110, 0x00000400, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25104, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26804, 0x00001211, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26884, 0x00000100, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26900, 0x00000002, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26908, 0x00700000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26904, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26984, 0x00001022, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26A04, 0x00000011, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26A80, 0x00000006, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26A88, 0x00000C02, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26A84, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26B04, 0x00001000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26B80, 0x00000002, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26B8C, 0x00000007, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26B84, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27804, 0x00004844, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27884, 0x00000400, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27900, 0x00000002, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27908, 0x0E000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27904, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27984, 0x00004088, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27A04, 0x00000044, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27A80, 0x00000006, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27A88, 0x00018040, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27A84, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27B04, 0x00004000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27B80, 0x00000002, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27B8C, 0x000000E0, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27B84, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26104, 0x00002222, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26184, 0x0C006666, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26284, 0x04000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26304, 0x04000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26400, 0x00000002, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26410, 0x000000A0, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26404, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25420, 0x04108020, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25424, 0x1284A420, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2541C, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25428, 0x00042049, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x91bc, 0xe0400000, REGISTER_TYPE_PM ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x91c4, 0xe4500000, REGISTER_TYPE_PM ));
...
static TCompletionCode CreateMetricSet_HSW_ComputeBasic( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, uint32_t platformMask )
{
    CMetricSet*   metricSet            = nullptr;
    CMetric*      metric               = nullptr;
    CInformation* information          = nullptr;
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xd0 dw@0xd4 UADD" ));
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1b0 qw@0x1b8 UADD" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $EuSlicesTotalCount UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    }
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xc8 dw@0xcc UADD" ));
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1e0 qw@0x1e8 UADD" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $EuSlicesTotalCount 64 UMUL UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "$GpuCoreClocks 64 UMUL $EuSlicesTotalCount UMUL" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1d0 qw@0x1d8 UADD" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $EuSlicesTotalCount 64 UMUL UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "$GpuCoreClocks 64 UMUL $EuSlicesTotalCount UMUL" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metricSet->AddStartRegisterSet( 0, 0 ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x9840, 0x00000080, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x253A4, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2681C, 0x01F00800, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26820, 0x00001000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2781C, 0x01F00800, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26520, 0x00000007, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x265A0, 0x00000007, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25380, 0x00000010, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2538C, 0x00300000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25384, 0xAA8AAAAA, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25404, 0xFFFFFFFF, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26800, 0x00004202, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26808, 0x00605817, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2680C, 0x10001005, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26804, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27800, 0x00000102, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27808, 0x0C0701E0, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2780C, 0x000200A0, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27804, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26484, 0x44000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26704, 0x44000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26500, 0x00000006, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26510, 0x00000001, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26504, 0x88000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26580, 0x00000006, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26590, 0x00000020, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26584, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26104, 0x55822222, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26184, 0xAA866666, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25420, 0x08320C83, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25424, 0x06820C83, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2541C, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25428, 0x00000C03, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2710, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2714, 0x00800000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2718, 0xAAAAAAAA, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x271C, 0xAAAAAAAA, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2720, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2724, 0x00800000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2728, 0xAAAAAAAA, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x272C, 0xAAAAAAAA, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2740, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2744, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2748, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x274C, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2750, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2754, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2758, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x275C, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x91bc, 0xe0400000, REGISTER_TYPE_PM ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x91c4, 0xe4500000, REGISTER_TYPE_PM ));
...
static TCompletionCode CreateMetricSet_HSW_ComputeExtended( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, uint32_t platformMask )
{
    CMetricSet*   metricSet            = nullptr;
    CMetric*      metric               = nullptr;
    CInformation* information          = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$$EuUntypedReads0 $$UntypedReads0 FDIV" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$$EuUntypedWrites0 $$UntypedWrites0 FDIV" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metricSet->AddStartRegisterSet( 0, 0 ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x9840, 0x00000080, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2681C, 0x3EB00800, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26820, 0x00900000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25384, 0x02AAAAAA, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25404, 0x03FFFFFF, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26800, 0x00142284, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26808, 0x0E629062, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2680C, 0x3F6F55CB, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26810, 0x00000014, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26804, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26104, 0x02AAAAAA, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26184, 0x02AAAAAA, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25420, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25424, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2541C, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25428, 0x00000000, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2710, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2770, 0x0007fe2a, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2774, 0x0000ff00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2778, 0x0007fe6a, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x277c, 0x0000ff00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2780, 0x0007fe92, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2784, 0x0000ff00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2788, 0x0007fea2, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x278c, 0x0000ff00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2790, 0x0007fe32, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2794, 0x0000ff00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2798, 0x0007fe9a, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x279c, 0x0000ff00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27a0, 0x0007ff23, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27a4, 0x0000ff00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27a8, 0x0007fff3, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27ac, 0x0000fffe, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x91bc, 0xe0400000, REGISTER_TYPE_PM ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x91c4, 0xe4500000, REGISTER_TYPE_PM ));
...
static TCompletionCode CreateMetricSet_HSW_RenderBalance( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, uint32_t platformMask )
{
    CMetricSet*   metricSet            = nullptr;
    CMetric*      metric               = nullptr;
    CInformation* information          = nullptr;
    ...
    MD_CHECK_CC_RET( metricSet->SetApiSpecificId("GT03", 0, 0x40000003, 0x80000207, 0, 3,
    ...
    if( metric )
    {
        MD_CHECK_CC_RET( metric->SetSnapshotReportReadEquation( "dw@0xf4 dw@0xf8 UADD" ));
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1d8 qw@0x1e0 UADD" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self 4 UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Sampler0Texels $Sampler1Texels $Sampler2Texels $Sampler3Texels UADD UADD UADD 4 UMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Sampler0Busy $Sampler1Busy $Sampler2Busy $Sampler3Busy UADD UADD UADD $GpuCoreClocks FDIV $SamplersTotalCount FDIV 100 FMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Sampler0Bottleneck $Sampler1Bottleneck $Sampler2Bottleneck $Sampler3Bottleneck UADD UADD UADD $GpuCoreClocks FDIV $SamplersTotalCount FDIV 100 FMUL" ));
        MD_CHECK_CC_RET( metric->SetSnapshotReportDeltaFunction( "DELTA 32" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "100" ));
    }
...
static TCompletionCode CreateMetricSet_HSW_MemoryReads( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, uint32_t platformMask )
{
    CMetricSet*   metricSet            = nullptr;
    CMetric*      metric               = nullptr;
    CInformation* information          = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metricSet->AddStartRegisterSet( 0, 0 ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x9840, 0x00000080, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x253A4, 0x34300000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25440, 0x2D800000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25444, 0x00000008, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25128, 0x0E600000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25380, 0x00000450, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25390, 0x00052C43, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25384, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25400, 0x00006144, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25408, 0x0A418820, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2540C, 0x000820E6, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25404, 0xFF500000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25100, 0x000005D6, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2510C, 0x0EF00000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25104, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25420, 0x02108421, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25424, 0x00008421, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2541C, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25428, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2724, 0xf0800000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2720, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2714, 0xf0800000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2710, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x274c, 0x76543298, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2748, 0x98989898, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2744, 0x000000e4, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2740, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x275c, 0x98a98a98, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2758, 0x88888888, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2754, 0x000c5500, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2750, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2770, 0x0007f81a, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2774, 0x0000fc00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2778, 0x0007f82a, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x277c, 0x0000fc00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2780, 0x0007f872, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2784, 0x0000fc00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2788, 0x0007f8ba, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x278c, 0x0000fc00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2790, 0x0007f87a, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2794, 0x0000fc00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2798, 0x0007f8ea, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x279c, 0x0000fc00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27a0, 0x0007f8e2, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27a4, 0x0000fc00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27a8, 0x0007f8f2, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27ac, 0x0000fc00, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x91bc, 0xe0400000, REGISTER_TYPE_PM ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x91c4, 0xe4500000, REGISTER_TYPE_PM ));
...
static TCompletionCode CreateMetricSet_HSW_MemoryWrites( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, uint32_t platformMask )
{
    CMetricSet*   metricSet            = nullptr;
    CMetric*      metric               = nullptr;
    CInformation* information          = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metric->SetDeltaReportReadEquation( "qw@0x1f0" ));
        MD_CHECK_CC_RET( metric->SetNormalizationEquation( "$Self $$LlcWrAccesses USUB 64 UMUL $$LlcWrAccesses 32 UMUL UADD" ));
        MD_CHECK_CC_RET( metric->SetMaxValueEquation( "$GpuCoreClocks 64 UMUL" ));
    }
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x9840, 0x00000080, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x253A4, 0x34300000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25440, 0x01500000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25444, 0x00000120, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25128, 0x0C200000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25380, 0x00000450, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25390, 0x00052C43, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25384, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25400, 0x00007184, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25408, 0x0A418820, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2540C, 0x000820E6, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25404, 0xFF500000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25100, 0x000005D6, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2510C, 0x1E700000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25104, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25420, 0x02108421, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25424, 0x00008421, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2541C, 0x00000000, REGISTER_TYPE_NOA ));
        ...
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2744, 0x000000e4, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2740, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x275c, 0xbabababa, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2758, 0x88888888, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2754, 0x000c5500, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2750, 0x00000000, REGISTER_TYPE_OA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2770, 0x0007f81a, REGISTER_TYPE_OA ));
...
static TCompletionCode CreateMetricSet_HSW_SamplerBalance( CMetricsDevice* metricsDevice, CConcurrentGroup* concurrentGroup, uint32_t platformMask )
{
    CMetricSet*   metricSet            = nullptr;
    CMetric*      metric               = nullptr;
    CInformation* information          = nullptr;
    ...
    if( metric )
    {
        ...
        MD_CHECK_CC_RET( metricSet->AddStartRegisterSet( 0, 0 ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x9840, 0x00000080, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2eb9c, 0x01906400, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2fb9c, 0x01906400, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x253a4, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26b9c, 0x01906400, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27b9c, 0x01906400, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27104, 0x00a00000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27184, 0x00a50000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2e804, 0x00500000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2e984, 0x00500000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2eb04, 0x00500000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2eb80, 0x00000084, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2eb8c, 0x14200000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2eb84, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2f804, 0x00050000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2f984, 0x00050000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2fb04, 0x00050000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2fb80, 0x00000084, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2fb8c, 0x00050800, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2fb84, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25380, 0x00000010, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2538c, 0x000000c0, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25384, 0xaa550000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25404, 0xffffc000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26804, 0x50000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26984, 0x50000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26b04, 0x50000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26b80, 0x00000084, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26b90, 0x00050800, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26b84, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27804, 0x05000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27984, 0x05000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27b04, 0x05000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27b80, 0x00000084, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27b90, 0x00000142, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x27b84, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26104, 0xa0000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x26184, 0xa5000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25424, 0x00008620, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2541c, 0x00000000, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x25428, 0x0004a54a, REGISTER_TYPE_NOA ));
        MD_CHECK_CC_RET( metricSet->AddStartConfigRegister( 0x2740, 0x00000000, REGISTER_TYPE_OA ));
