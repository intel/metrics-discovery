...
//     File Name:  md_metric_sets_SKL_GT4.h
//
...
namespace MetricsDiscoveryInternal::MetricSets_SKL_GT4_MMIO_Regs
{
    void AddInformationSet( CConcurrentGroup* concurrentGroup );

    class CMcRequestsMetricSet : public CMetricSet
    {
    public:
        CMcRequestsMetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );

        TCompletionCode Initialize();
    };

    class CEdramTrafficMetricSet : public CMetricSet
    {
    public:
        CEdramTrafficMetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );
...
namespace MetricsDiscoveryInternal::MetricSets_SKL_GT4_PipelineStatistics
{
...
namespace MetricsDiscoveryInternal::MetricSets_SKL_GT4_OA
{
    void AddInformationSet( CConcurrentGroup* concurrentGroup );
    ...
    class CHDCAndSF_1MetricSet : public CMetricSet
    {
    public:
        CHDCAndSF_1MetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );

        TCompletionCode Initialize();
    };

    class CHDCAndSF_2MetricSet : public CMetricSet
    {
    public:
        CHDCAndSF_2MetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );
    ...
    class CL3_2MetricSet : public CMetricSet
    {
    public:
    ...
    class CL3_3MetricSet : public CMetricSet
    {
    public:
    ...
    class CL3_4MetricSet : public CMetricSet
    {
    public:
    ...
    class CL3_5MetricSet : public CMetricSet
    {
    public:
        CL3_5MetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );
    ...
    class CL3_6MetricSet : public CMetricSet
    {
    public:
    ...
    class CRasterizerAndPixelBackend_1MetricSet : public CMetricSet
    {
    public:
        CRasterizerAndPixelBackend_1MetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );

        TCompletionCode Initialize();
    };

    class CRasterizerAndPixelBackend_2MetricSet : public CMetricSet
    {
    public:
        CRasterizerAndPixelBackend_2MetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );
    ...
    class CVMEPipeMetricSet : public CMetricSet
    {
    public:
        CVMEPipeMetricSet( CMetricsDevice* device, CConcurrentGroup* concurrentGroup, const char* symbolicName, const char* shortName, uint32_t apiMask, uint32_t category, uint32_t snapshotReportSize, uint32_t deltaReportSize, TReportType reportType, TByteArrayLatest* platformMask, uint32_t gtMask = GT_TYPE_ALL, bool isCustom = false );
