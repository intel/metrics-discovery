...
namespace MetricsDiscoveryInternal::MetricSets_SKL_GT4_MMIO_Regs
{
    ...
    class CEdramTrafficMetricSet final : public CMetricSet
    {
    public:
...
namespace MetricsDiscoveryInternal::MetricSets_SKL_GT4_OA
{
    ...
    class CHDCAndSF_1MetricSet final : public CMetricSet
    {
    public:
    ...
    class CHDCAndSF_2MetricSet final : public CMetricSet
    {
    public:
    ...
    class CRasterizerAndPixelBackend_1MetricSet final : public CMetricSet
    {
    public:
    ...
    class CRasterizerAndPixelBackend_2MetricSet final : public CMetricSet
    {
    public:
    ...
    class CVMEPipeMetricSet final : public CMetricSet
    {
    public:
