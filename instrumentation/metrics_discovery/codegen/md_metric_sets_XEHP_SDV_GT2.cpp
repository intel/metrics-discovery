...
//     File Name:  md_metric_sets_XEHP_SDV_GT2.cpp
//
...
namespace MetricsDiscoveryInternal::MetricSets_XEHP_SDV_GT2_OA
{
    void AddInformationSet( CConcurrentGroup* concurrentGroup )
    {
        ...
        information = concurrentGroup->AddInformation( "ReportCtxSwitchLost", "Query report context switch lost", "Oa buffer has not been browsed to find context switch reports to filter out unfamiliar contexts from the query report.", "Report Meta Data", API_TYPE_DX9 | API_TYPE_DX10 | API_TYPE_DX11 | API_TYPE_DX12 | API_TYPE_VULKAN | API_TYPE_OGL | API_TYPE_OGL4_X | API_TYPE_OCL, INFORMATION_TYPE_FLAG, nullptr, nullptr, 21 );
        if( information )
        {
    ...
    TCompletionCode CRenderBasicMetricSet::Initialize()
    {
        ...
        if( AddStartRegisterSet( 0, 0, availabilityEquation ) == CC_OK )
        {
            ...
            AddStartConfigRegister( 0xdc48, 0x00ff0000, REGISTER_TYPE_OA );
            AddStartConfigRegister( 0xdd48, 0x000f0000, REGISTER_TYPE_OA );
