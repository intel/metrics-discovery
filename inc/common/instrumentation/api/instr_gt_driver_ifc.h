...
typedef enum GTDI_DEVICE_PARAM_ENUM
{
    ...
    GTDI_DEVICE_PARAM_OA_BUFFER_ACTIVE,
    GTDI_DEVICE_PARAM_GPU_CS_TIMESTAMP_FREQUENCY, // From CS timestamp frequency domain
    GTDI_DEVICE_PARAM_DRAM_TOTAL_VIDEO_MEMORY,
    GTDI_DEVICE_PARAM_TOTAL_SYSTEM_MEMORY,
    GTDI_DEVICE_PARAM_OS_ADAPTER_ID, // OS dependent adapter ID
